...
//! Pair potential force compute for lj lambda forces
typedef PotentialPair<EvaluatorPairLJLambda> PotentialPairLJLambda;
...
//! Pair potential force compute for lj_lambda forces on the GPU
typedef PotentialPairGPU< EvaluatorPairLJLambda, gpu_compute_lj_lambda_forces > PotentialPairLJLambdaGPU;
